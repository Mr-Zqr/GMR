...
def split_pickle_file(input_pkl, output_dir):
    ...
    # If list of dict, use old logic; if list of list, just save each as a pkl
    if data and isinstance(data[0], dict):
        ...
        # ...existing code for dict splitting...
        ...
        # List of list or other, just save each element as a .pkl
        print(f"Detected list of {type(data[0]).__name__}, saving each element as a .pkl file...")
        for idx, element in enumerate(data):
            out_file = output_path / f"{idx + 1}.pkl"
